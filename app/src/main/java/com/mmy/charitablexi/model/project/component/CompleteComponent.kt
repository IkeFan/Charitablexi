...
import com.mmy.charitablexi.model.project.ui.fragment.CompleteFragment
 ...
 */
@FragmentScope
@Component(modules = arrayOf(CompleteModule::class),dependencies = arrayOf(AppComponent::class))
interface CompleteComponent {
    fun inject(f: CompleteFragment)
}