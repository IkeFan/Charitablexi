...
public class HeartLayout extends RelativeLayout implements View.OnClickListener {
    ...
    private void findViewById(Context context) {
        ...
        bitmap = BitmapFactory.decodeResource(getResources(), R.mipmap.icon_like_png);
    ...
    private static int[] drawableIds = new int[]{R.mipmap.heart0, R.mipmap.heart1, R.mipmap.heart2, R.mipmap.heart3, R.mipmap.heart4, R.mipmap.heart5, R.mipmap.heart6, R.mipmap.heart7, R.mipmap.heart8,};
