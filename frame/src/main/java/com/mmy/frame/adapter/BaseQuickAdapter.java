...
import com.mmy.frame.adapter.animation.AlphaInAnimation;
import com.mmy.frame.adapter.animation.BaseAnimation;
import com.mmy.frame.adapter.animation.ScaleInAnimation;
import com.mmy.frame.adapter.animation.SlideInBottomAnimation;
import com.mmy.frame.adapter.animation.SlideInLeftAnimation;
import com.mmy.frame.adapter.animation.SlideInRightAnimation;
import com.mmy.frame.adapter.entity.IExpandable;
import com.mmy.frame.adapter.loadmore.LoadMoreView;
import com.mmy.frame.adapter.loadmore.SimpleLoadMoreView;
import com.mmy.frame.adapter.util.MultiTypeDelegate;
...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
    ...
    /**
     * same as recyclerView.setAdapter(), and save the frameInstance of recyclerView
     */
    ...
    /**
     * setting up a new frameInstance to data;
     *
     * @param data
     */
    ...
    /**
     * @param spanSizeLookup frameInstance to be used to query number of spans occupied by each item
     */
    ...
    private void bindViewClickListener(final BaseViewHolder baseViewHolder) {
        ...
        if (getOnItemClickListener() != null) {
            view.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    getOnItemClickListener().onItemClick(BaseQuickAdapter.this, v, baseViewHolder,baseViewHolder.getLayoutPosition() - getHeaderLayoutCount());
                }
            });
        }
        if (getOnItemLongClickListener() != null) {
            view.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    return getOnItemLongClickListener().onItemLongClick(BaseQuickAdapter.this, v,baseViewHolder, baseViewHolder.getLayoutPosition() - getHeaderLayoutCount());
                }
            });
        }
    }
    ...
    /**
     * try to create Generic K frameInstance
     *
     * @param z
     * @param view
     * @return
    ...
    public interface OnItemLongClickListener {
         ...
         *@param position The position of the view int the adapter  @return true if the callback consumed the long click ,false otherwise
         */
        boolean onItemLongClick(BaseQuickAdapter adapter, View view, BaseViewHolder baseViewHolder, int position);
    }
    ...
    public interface OnItemClickListener {
         ...
         */
        void onItemClick(BaseQuickAdapter adapter, View view, BaseViewHolder baseViewHolder, int position);
    }
